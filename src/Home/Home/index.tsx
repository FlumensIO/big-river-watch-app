      ...
      <Main>
        ...
        <IonItemGroup>
          <IonRouterLink routerLink="/survey" routerDirection="none">
            <button className="absolute bottom-[12vh] left-1/2 h-14 w-2/3 -translate-x-1/2 -translate-y-1/2 transform rounded-xl bg-secondary text-center text-lg font-bold shadow-2xl shadow-secondary-900">
